...
// Then('Logged in user is displayed', async ({ page }) => {
//     const loginPage = new LoginPage(page);
//     const loggedInAs = page.locator('xpath=//*[@id="header"]/div/div/div/div[2]/div/ul/li[10]/a/b');
//     await loginPage.tryClickConsent();
//     await expect(loggedInAs).toContainText("John Doe");
// });
